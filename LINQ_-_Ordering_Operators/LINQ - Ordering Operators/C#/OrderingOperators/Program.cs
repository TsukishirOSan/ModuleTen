    ...
    class Program
    {
        ...
        class LinqSamples
        {
            ...
            public void Linq30()
            {
                ...
                // uncomment below to check the method's results
            ...
            public void Linq32()
            {
                ...
                var sortedDoubles =
                    from dble in doubles
                    orderby dble descending
                    select dble;
                Console.WriteLine("The doubles from highest to lowest:");
                foreach (var dble in sortedDoubles)
                {
                    Console.WriteLine(dble);
                }
                Console.ReadKey();// to check the results
            }
