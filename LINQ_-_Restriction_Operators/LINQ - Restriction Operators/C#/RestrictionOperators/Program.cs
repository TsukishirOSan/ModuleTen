        ...
        public class LinqSamples
        {
            ...
            public void Linq3()
            {
                ...
                var expensiveInStockProducts =
                    ...
                    from prod in products
                    // where the attribute price is greater than 3 also for the product to actually be in the sock
                ...
                Console.ReadKey();//To be able to read the answers to check if the method works
            }
            ...
            public void Linq4()
            {
                ...
                var waCustomers =
                    ...
                    select cust;
                Console.WriteLine("Customers from Washington and their orders:");// there is none int he Customer list
                ...
                Console.ReadKey(); // to be able to read the answers to check if the method is correct
            }
